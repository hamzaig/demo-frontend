import { USER_CREATE_PIN_FAIL, USER_CREATE_PIN_REQUEST, USER_CREATE_PIN_RESET, USER_CREATE_PIN_SUCCESS, USER_LOGIN_FAIL, USER_LOGIN_REQUEST, USER_LOGIN_RESET, USER_LOGIN_SUCCESS, USER_LOGOUT_REQUEST, USER_LOGOUT_SUCCESS, USER_OTP_GENERATE_FAIL, USER_OTP_GENERATE_REQUEST, USER_OTP_GENERATE_RESET, USER_OTP_GENERATE_SUCCESS, USER_PIN_CHANGE_FAIL, USER_PIN_CHANGE_REQUEST, USER_PIN_CHANGE_SUCCESS, USER_PIN_RESET_FAIL, USER_PIN_RESET_REQUEST, USER_PIN_RESET_RESET, USER_PIN_RESET_SUCCESS, USER_VERIFY_OTP_FAIL, USER_VERIFY_OTP_REQUEST, USER_VERIFY_OTP_RESET, USER_VERIFY_OTP_SUCCESS } from "../constants/authConstants";
...
export const userPinChangeReducer = (state = {}, action) => {
  switch (action.type) {
    case USER_PIN_CHANGE_REQUEST:
      return { loading: true };
    case USER_PIN_CHANGE_SUCCESS:
      return { loading: false, success: true };
    case USER_PIN_CHANGE_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
